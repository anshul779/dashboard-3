// Preserved production specialty schemas (including the complete Ophthalmology implementation).
// Do not edit Ophthalmology categories/sections/fields here unless expanding additively.

export const EXISTING_SPECIALTY_SCHEMAS = {
  Ophthalmology: {
    id: 'Ophthalmology',
    name: 'Ophthalmology',
    categories: [
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'ref_subj_od_axis', label: 'Right Eye Axis', type: 'text', placeholder: '90Â°' },
              ...
              { id: 'ref_subj_os_axis', label: 'Left Eye Axis', type: 'text', placeholder: '180Â°' },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'iop_pachymetry', label: 'Pachymetry', type: 'text', placeholder: 'OD: 545 Âµm / OS: 550 Âµm' },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'gl_oct', label: 'OCT RNFL & GCC', type: 'textarea', placeholder: 'OCT average RNFL thickness (OD: 72Âµm, OS: 68Âµm)...' },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'ret_oct', label: 'OCT Findings', type: 'textarea', placeholder: 'Central Macular Thickness (CMT: 320Âµm), SRF, PED...' },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'rs_pachymetry', label: 'Thinnest Pachymetry', type: 'text', placeholder: '525 Âµm' },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'card_htn', label: 'Hypertension', type: 'select', options: ['No', 'Stage 1 (130-139/80-89)', 'Stage 2 (â‰¥140/90)', 'Resistant HTN', 'On Treatment'] },
              ...
              { id: 'card_hf_hx', label: 'Heart Failure History', type: 'select', options: ['No', 'HFrEF (EF<40%)', 'HFmrEF (EF 40-49%)', 'HFpEF (EFâ‰¥50%)'] },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'card_peripheral_pulses', label: 'Peripheral Pulses', type: 'textarea', placeholder: 'Radial, Brachial, Carotid, Femoral, Popliteal, Dorsalis Pedis, Posterior Tibial â€” all palpable...' },
              ...
              { id: 'card_murmur_site', label: 'Murmur Location & Radiation', type: 'text', placeholder: 'Apex â†’ Axilla, Aortic area â†’ Carotids...' },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'gen_temp', label: 'Temperature (Â°F)', type: 'text', placeholder: '98.6 Â°F' },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'ortho_rom', label: 'Range of Motion (ROM)', type: 'textarea', placeholder: 'Flexion 0-120Â°, Extension lag 10Â°...' },
          ...
          },
          {
            ...
            fields: [
              ...
              { id: 'ortho_slr', label: 'Straight Leg Raising (SLR)', type: 'text', placeholder: 'Positive at 40Â° on right' },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'ped_vitals', label: 'Vitals (HR/RR/Temp/SpO2)', type: 'text', placeholder: 'HR: 120, RR: 28, T: 99Â°F, SpO2: 98%' },
        ...
        sections: [
          {
            ...
            defaultVisible: true,
            fields: [
              { id: 'neuro_diag_primary', label: 'Primary Diagnosis', type: 'select', options: ['Migraine', 'Tension-type Headache', 'Epilepsy (Idiopathic)', 'Epilepsy (Focal)', 'Ischemic Stroke', 'Hemorrhagic Stroke', 'TIA', 'Parkinson Disease', 'Essential Tremor', 'Bell Palsy', 'Trigeminal Neuralgia', 'Multiple Sclerosis', 'Guillain-BarrÃ© Syndrome', 'Myasthenia Gravis', 'Motor Neuron Disease (ALS)', 'Alzheimer Disease', 'Vascular Dementia', 'Meningitis', 'Encephalitis', 'Brain Tumor', 'Cervical / Lumbar Radiculopathy', 'Carpal Tunnel Syndrome', 'Peripheral Neuropathy', 'Diabetic Neuropathy', 'Neurocysticercosis'] },
        ...
        sections: [
          {
            ...
            defaultVisible: true,
            fields: [
              { id: 'neph_ckd_stage', label: 'CKD Stage', type: 'select', options: ['Stage 1 (eGFR â‰¥90)', 'Stage 2 (eGFR 60-89)', 'Stage 3a (eGFR 45-59)', 'Stage 3b (eGFR 30-44)', 'Stage 4 (eGFR 15-29)', 'Stage 5 (eGFR <15 / ESRD)', 'Acute Kidney Injury (AKI)'] },
              { id: 'neph_egfr', label: 'eGFR (mL/min/1.73mÂ²)', type: 'text', placeholder: '45' },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'hem_wbc', label: 'WBC Count (/ÂµL)', type: 'text', placeholder: '6,500' },
              { id: 'hem_platelets', label: 'Platelet Count (/ÂµL)', type: 'text', placeholder: '150,000' },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { id: 'em_vitals', label: 'Primary Vitals', type: 'text', placeholder: 'BP: 110/70, HR: 110, RR: 24, SpO2: 94%, Temp: 101Â°F' },
...
// OPTIONAL CLINICAL FOCUS CONTEXT
// Clinical focus is purely optional encounter metadata (classification, filtering,
// analytics, reporting). It MUST NEVER drive, replace, or filter the specialty schema.
// The complete specialty documentation remains available regardless of focus selection.
